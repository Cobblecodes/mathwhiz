  ...
  return (
    <Card className="shadow-lg">
      ...
      <CardContent className="grid grid-cols-2 gap-4 text-center">
        <div className="flex flex-col items-center p-3 bg-muted/50 rounded-lg shadow-sm">
        ...
        <div className="flex flex-col items-center p-3 bg-muted/50 rounded-lg shadow-sm">
         ...
         <div className="col-span-2 flex flex-col items-center p-3 bg-primary/10 rounded-lg shadow-sm">
